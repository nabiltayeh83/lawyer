...
@section('title')
    ...
    {{__('cp.add_common')}} {{__('cp.owner_common')}}
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              ...
                              style="color: #e02222 !important;">{{__('cp.add_common')}} {{__('cp.owner_common')}}</span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control" name="password" value=""
                                               ...
                                               placeholder=" {{__('cp.password_common')}} " {{ old('passowrd') }} required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" class="form-control" name="confirm_password" value=""
                                               ...
                                               placeholder=" {{__('cp.confirm_password_common')}} " {{ old('confirm_password') }} required>
