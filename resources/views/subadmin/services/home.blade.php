        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/subadmin/services/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/subadmin/services')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('subadmin/services')}}" type="submit"
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/subadmin/services_changeStatus")}}">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('cp.service_provider_name_bunch'))}}</th>
                    <th> {{ucwords(__('cp.name_services_bunch'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        <td>
                         ...
                         <td>
                            ...
                            @foreach($locales as $locale)
                                {{$item->company->translate($locale->lang)->name}}
                            @endforeach
                            @endif
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/subadmin/services/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
            ...
            console.log(id);
            console.log(iss_id);
                    var url = '{{url(getLocal()."/subadmin/services")}}/' + id ;
