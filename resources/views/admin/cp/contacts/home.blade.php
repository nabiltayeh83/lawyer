...
@section('title') {{ucwords(__('cp.contact_messages'))}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/contact')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/contact')}}" type="submit"
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                @forelse($items as $item)
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td> {{$item->name}}</td>
                        <td> {{$item->email}}</td>
                        <td><span class="label label-sm <?php echo ($item->read == 1)
...
@section('script')
    <script>
         ...
         function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
                    var url = '{{url(getLocal()."/admin/contact")}}/' + id;
