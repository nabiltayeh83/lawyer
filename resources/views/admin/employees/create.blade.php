                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              style="color: #e02222 !important;"> {{__('cp.add')}}  {{__('cp.employee')}} 
                              </span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/employees')}}"
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    placeholder="{{__('cp.full_name')}}"  value="{{old('name')}}" required>
